...
export class PhoneRequestItems extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PhoneRequestItems entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PhoneRequestItems must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PhoneRequestItems", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): PhoneRequestItems | null {
    return changetype<PhoneRequestItems | null>(
      store.get_in_block("PhoneRequestItems", id.toHexString())
    );
  }

  static load(id: Bytes): PhoneRequestItems | null {
    return changetype<PhoneRequestItems | null>(
      store.get("PhoneRequestItems", id.toHexString())
    );
  }
...
export class PhoneLinkItems extends Entity {
  constructor(id: Bytes) {
    super();
    this.set("id", Value.fromBytes(id));
  }
  ...
  save(): void {
    let id = this.get("id");
    assert(id != null, "Cannot save PhoneLinkItems entity without an ID");
    if (id) {
      assert(
        id.kind == ValueKind.BYTES,
        `Entities of type PhoneLinkItems must have an ID of type Bytes but the id '${id.displayData()}' is of type ${id.displayKind()}`
      );
      store.set("PhoneLinkItems", id.toBytes().toHexString(), this);
    }
  }

  static loadInBlock(id: Bytes): PhoneLinkItems | null {
    return changetype<PhoneLinkItems | null>(
      store.get_in_block("PhoneLinkItems", id.toHexString())
    );
  }

  static load(id: Bytes): PhoneLinkItems | null {
    return changetype<PhoneLinkItems | null>(
      store.get("PhoneLinkItems", id.toHexString())
    );
  }
